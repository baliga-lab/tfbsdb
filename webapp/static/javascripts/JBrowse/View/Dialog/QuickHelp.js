...
return declare( InfoDialog, {
    ...
    _makeDefaultContent: function() {
        return    ''
                ...
                + '<dt>Moving</dt>'
                + '<dd><ul>'
                + '    <li>Move the view by clicking and dragging in the track area, or by clicking <img height="20px" src="static/images/jbrowse/slide-left.png"> or <img height="20px"  src="static/images/jbrowse/slide-right.png"> in the navigation bar, or by pressing the left and right arrow keys.</li>'
                ...
                + '<dt>Zooming</dt>'
                + '<dd><ul>'
                + '    <li>Zoom in and out by clicking <img height="20px" src="static/images/jbrowse/zoom-in-1.png"> or <img height="20px"  src="static/images/jbrowse/zoom-out-1.png"> in the navigation bar, or by pressing the up and down arrow keys while holding down "shift".</li>'
