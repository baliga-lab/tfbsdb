...
Browser.prototype.browserMeta = function() {
    ...
    if( about.description ) {
        ...
        about.description = '<div class="default_about">'
            + '  <img class="logo" src="static/images/jbrowse/JBrowseLogo_small.png">'
...
Browser.prototype.createNavBox = function( parent ) {
    ...
    moveLeft.type = "image";
    moveLeft.src = "static/images/jbrowse/slide-left.png";
    ...
    moveRight.src = "static/images/jbrowse/slide-right.png";
    ...
    bigZoomOut.src = "static/images/jbrowse/zoom-out-2.png";
    ...
    zoomOut.type = "image";
    zoomOut.src = "static/images/jbrowse/zoom-out-1.png";
    zoomOut.id = "zoomOut";
    ...
    zoomIn.type = "image";
    zoomIn.src = "static/images/jbrowse/zoom-in-1.png";
    zoomIn.id = "zoomIn";
    ...
    bigZoomIn.src = "static/images/jbrowse/zoom-in-2.png";
